  ...
  return (
    <section id="contact" className="py-24 border-t border-border-subtle">
      <div className="container-x">
        <div className="relative card p-10 md:p-16 overflow-hidden bg-gradient-to-br from-green-500/5 via-bg-surface to-emerald-500/5">
          <div className="relative max-w-3xl">
            <div className="text-sm font-semibold text-emerald-400 uppercase tracking-wider mb-3">{t.cta.eyebrow}</div>
          ...
          <div className="absolute -bottom-20 -left-20 w-96 h-96 bg-emerald-500/20 rounded-full blur-[100px] pointer-events-none" />
        </div>
      </div>
    </section>
  );
