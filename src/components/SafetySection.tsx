          ...
          <div className="space-y-3">
            {t.safety.ladder.map((r, i) => (
              <div key={r.stage} className="flex items-start gap-4 py-3 border-b border-border-subtle last:border-b-0">
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-green-500/10 ring-1 ring-green-500/30 flex items-center justify-center text-xs font-mono font-bold text-green-300">
                  {i + 1}
                </div>
                <div>
